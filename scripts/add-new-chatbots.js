/**
 * Bulk Add New Sales AI Chatbots
 *
 * This script adds 11 new chatbot tools to the database.
 * Run with: node scripts/add-new-chatbots.js
 */
...
console.log('New Chatbots to Add:');
console.log('===================\n');

newChatbots.forEach((bot, index) => {
  console.log(`${index + 1}. ${bot.title}`);
  console.log(`   URL: ${bot.url}`);
  console.log(`   Tags: ${bot.tags.join(', ')}`);
  console.log('');
});

console.log('\nTo add these to the database, use the API endpoint:');
console.log('POST https://your-site.com/api/tools');
console.log('\nOr copy this array into your application code.');

// Export for use in other scripts
if (typeof module !== 'undefined' && module.exports) {
  module.exports = newChatbots;
}
