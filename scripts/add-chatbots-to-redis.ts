/**
 * Add New Chatbots Directly to Redis
 *
 * Run with: tsx scripts/add-chatbots-to-redis.ts
 */
...
async function addChatbotsToRedis() {
  console.log('🤖 Adding Chatbots to Redis Database...\n');
  ...
  if (!redisUrl) {
    ...
    console.error('   Please set KV_REST_API_URL or REDIS_URL in .env.local');
    process.exit(1);
  }
